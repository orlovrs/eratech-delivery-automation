...
exports.CdekClient = void 0;
const config_1 = require("../config");
class CdekClient {
    baseUrl = config_1.Config.CDEK_BASE_API;
    grantType = 'client_credentials';
    clientId = config_1.Config.CDEK_CLIENT_ID;
    clientSecret = config_1.Config.CDEK_CLIENT_SECRET;
    byCityNameUrl = '/v2/location/suggest/cities';
    zipCodesUrl = '/v2/location/postalcodes';
    ...
    async getDeliveryOptions(fromCity, toCity, hasInsurance, smsPhone, packages) {
        ...
        if (smsPhone && config_1.Config.SMS_ENABLED) {
            services.push({
                code: "SMS",
                parameter: smsPhone
            });
